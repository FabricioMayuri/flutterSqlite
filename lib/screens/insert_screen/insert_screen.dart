...
import 'package:pruebatecnica/screens/insert_screen/controller/insert_controller.dart';
...
class InsertScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<InsertController>(
      init: InsertController(),
      builder: (_) => Scaffold(
